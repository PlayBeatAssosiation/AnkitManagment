    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAEBdxhjtyB8AXMlYwXhq28KQVDYP0OzmAACTgYAAgGIqVUJOrEb7kjYoC0E"
            )
...
def Fallen_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "fallen_":
        ...
        query.message.edit_text(
            text=f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {BOT_NAME}*"
            "\n*ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ʙᴜɪʟᴛ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇᴀꜱɪʟʏ ᴀɴᴅ ᴛᴏ ᴘʀᴏᴛᴇᴄᴛ ʏᴏᴜʀ ɢʀᴏᴜᴘ ꜰʀᴏᴍ ꜱᴄᴀᴍᴍᴇʀꜱ ᴀɴᴅ ꜱᴏᴍᴇ ᴍᴀᴅᴀʀᴄʜᴏᴅ ᴀɴᴅ ʙʜᴏsᴅɪᴡᴀʟᴇ .*"
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://te.legra.ph/file/f20356d6f6ee0a0efd7b8.mp4

{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://te.legra.ph/file/f20356d6f6ee0a0efd7b8.mp4).
© 2022 - 2023 [@ᴜsᴇʀ_ᴀɴᴋɪᴛ](https://t.me/{@User_Ankit}), ᴀʟʟ ʀɪɢʜᴛs ᴀʀᴇ ʀᴇsᴇʀᴠᴇᴅ ʙʏ @User_Ankit .
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                ...
                photo=START_IMG,
                caption=f"""
ㅤ🥀 {BOT_NAME} ɪs sᴛɪʟʟ ᴀʟɪᴠᴇ baby🥀...
...
ㅤ★ **ᴛᴇʟᴇᴛʜᴏɴ :** `{tlhver}`
ㅤ★ **ᴩʏʀᴏɢʀᴀᴍ :** `{pyrover}`
  ★ **ᴍᴀᴅᴇ ᴡɪᴛʜ ❤ ʙʏ [ᴀɴᴋɪᴛ🚨](https://t.me/User_Ankit) 
┗•❅────✧❅✦❅✧────❅•┛""",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
